...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    GPIO_InitStruct.Pin = APPS_1_Pin|APPS_2_Pin|BPPS_1_Pin|BPPS_2_Pin
                          |STEERING_ANGLE_1_Pin|STEERING_ANGLE_2_Pin;
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PA5     ------> ADC2_IN5
    */
    GPIO_InitStruct.Pin = TANK_1_ANALOG_Pin|TANK_2_ANALOG_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = BRAKE_PRESSURE_1_Pin|BRAKE_PRESSURE_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, APPS_1_Pin|APPS_2_Pin|BPPS_1_Pin|BPPS_2_Pin
                          |STEERING_ANGLE_1_Pin|STEERING_ANGLE_2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA5     ------> ADC2_IN5
    */
    HAL_GPIO_DeInit(GPIOC, TANK_1_ANALOG_Pin|TANK_2_ANALOG_Pin);

    HAL_GPIO_DeInit(GPIOA, BRAKE_PRESSURE_1_Pin|BRAKE_PRESSURE_2_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = SDC_STATUS_LED_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(SDC_STATUS_LED_GPIO_Port, &GPIO_InitStruct);
